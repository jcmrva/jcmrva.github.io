		...
		switch (msg.$) {
			case 'UrlUpdate':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							decodedUrl: A2(decoded, model.noSafelinks, url),
							inputUrl: url
						}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleSafelinks':
				var sf = !model.noSafelinks;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							decodedUrl: A2(decoded, sf, model.inputUrl),
							noSafelinks: sf
						}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleComponents':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showComponents: !model.showComponents}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$ToggleClickableUrl = {$: 'ToggleClickableUrl'};
var $author$project$Main$ToggleComponents = {$: 'ToggleComponents'};
var $author$project$Main$ToggleSafelinks = {$: 'ToggleSafelinks'};
...
var $author$project$Main$protocolString = function (p) {
	if (p.$ === 'Http') {
		return 'HTTP';
	} else {
		return 'HTTPS';
	...
	var formatKV = function (kv) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					kv.a + (': ' + A2($elm$core$Maybe$withDefault, '', kv.b)))
				]));
	};
	return A2(
		$elm$html$Html$div,
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$value(model.inputUrl),
								$elm$html$Html$Events$onInput($author$project$Main$UrlUpdate),
						...
						_List_fromArray(
							[
								A2($author$project$Main$formatDecodedUrl, model.clickable, model.decodedUrl)
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"UrlUpdate":["String.String"],"ToggleSafelinks":[],"ToggleComponents":[],"ToggleClickableUrl":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));